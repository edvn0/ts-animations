...
export async function query<Output>(q: Query, values?: any[], retries = 1): Promise<ResultIterator<Output>> {
	try {
...
export async function queryOne<Output>(q: Query, values?: any[], retries = 1): Promise<Output | null> {
	try {
